...
// Auto-fill PIN modal key input if BaseModalKeyInput is set
document.addEventListener("DOMContentLoaded", function () {
    try {
        if (typeof BaseModalKeyInput !== "undefined") {
            const el = document.getElementById("pinKeyInput");
            if (el && BaseModalKeyInput.trim() !== "") {
                el.value = BaseModalKeyInput;
            }
        }
    } catch (e) {
        console.error("BaseModalKeyInput initialization error:", e);
    }
});
// Auto-fill PIN modal key input if BaseModalKeyInput is set ends here